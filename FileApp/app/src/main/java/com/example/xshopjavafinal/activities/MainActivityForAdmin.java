...
import com.example.xshopjavafinal.fragments.DonDatHangAdminFragment;
import com.example.xshopjavafinal.fragments.NotificationAdminFragment;
...
public class MainActivityForAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_layoutClient, new DonDatHangAdminFragment()).commit();
...
//                            break;
        ...
        replaceFragment(new DonDatHangAdminFragment());
        ...
        bottomNavigationViewClient.setOnItemSelectedListener(item -> {
            ...
            switch (item.getItemId()) {
                case R.id.home:
                    ...
                    break;
                case R.id.shorts:
                    replaceFragment(new NotificationAdminFragment());
                    break;
    ...
    private void showBottomDialog() {
        ...
        layoutAccount.setOnClickListener(view -> {
            dialog.dismiss();
            Intent intent = new Intent(MainActivityForAdmin.this, ThemThongBaoAdminActivity.class);
        ...
        liveLayout.setOnClickListener(v -> {
            ...
            dialog.dismiss();
            Intent intent = new Intent(MainActivityForAdmin.this, LoginActivity.class);
            startActivity(intent);
            finish();
